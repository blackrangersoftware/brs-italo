...
* Clone italo and checkout the most recent release version:
...
* If you would like a specific [version/tag](https://github.com/italocoin-project/italo/tags), do a git checkout for that version. eg. 'v0.16.0.0'. If you don't care about the version and just want binaries from master, skip this step:
