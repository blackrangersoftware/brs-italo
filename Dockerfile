...
# Create italo user
RUN adduser --system --group --disabled-password italo && \
	mkdir -p /wallet /home/italo/.bititalo && \
	chown -R italo:italo /home/italo/.bititalo && \
	chown -R italo:italo /wallet

# Contains the blockchain
VOLUME /root/.bititalo
